#!/bin/sh
# Provisiona os recursos AWS usados pelo case de e-commerce contra o LocalEmu.
# Roda num container dedicado (serviço "init" do docker-compose.yml), separado
# do emulador — por isso o endpoint aponta para o hostname "localemu" da rede
...
echo "==> Provisionamento no LocalEmu concluído com sucesso."
